...
impl Handshake {
    ...
    pub fn as_bytes_mut(&mut self) -> &mut [u8] {
        ...
        let slice = unsafe { std::slice::from_raw_parts_mut(ptr, std::mem::size_of::<Self>()) };
        slice
    }
}
...
impl Encoder<Message> for MessageFramer {
    ...
    fn encode(&mut self, item: Message, dst: &mut BytesMut) -> Result<(), Self::Error> {
        // Don't send a mesasge if it is longer than the other end will
        // accept.
...
impl Decoder for MessageFramer {
    ...
    fn decode(&mut self, src: &mut BytesMut) -> Result<Option<Self::Item>, Self::Error> {
        ...
        // this frame.
        let tag = src[4].try_into().map_err(|tag| {
            std::io::Error::new(
                std::io::ErrorKind::InvalidData,
...
impl Request {
    ...
    pub fn as_bytes(&self) -> &[u8] {
        ...
        let slice = unsafe { std::slice::from_raw_parts(ptr, std::mem::size_of::<Self>()) };
        slice
    }
}
...
impl Piece {
    ...
    pub fn ref_from_bytes(data: &[u8]) -> Option<&Self> {
        ...
        // the back!
        let piece = &data[..data.len() - Self::PIECE_LEAD] as *const [u8] as *const Piece;
